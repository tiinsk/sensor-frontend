...
export const additionalDefs = [
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="large-drop-gradient-1" key="large-drop-gradient-1">
    <stop stopColor="#EDC9D1" offset="0%"/>
    <stop stopColor="#CE96A3" offset="54.7518362%"/>
    <stop stopColor="#E68A6F" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="large-drop-gradient-2" key="large-drop-gradient-2">
    <stop stopColor="#F3D2D7" offset="0%"/>
    <stop stopColor="#D5A5AD" offset="54.7518362%"/>
    <stop stopColor="#DDB7B9" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="large-drop-gradient-3" key="large-drop-gradient-3">
    <stop stopColor="#ECD5D6" offset="0%"/>
    <stop stopColor="#DDB6B9" offset="54.7518362%"/>
    <stop stopColor="#A4B9D5" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="large-drop-gradient-4" key="large-drop-gradient-4">
    <stop stopColor="#E0E2EC" offset="0%"/>
    <stop stopColor="#B6B9CD" offset="54.7518362%"/>
    <stop stopColor="#9DBAD9" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="large-drop-gradient-5" key="large-drop-gradient-5">
    <stop stopColor="#F1F9FF" offset="0%"/>
    <stop stopColor="#86BAE3" offset="54.7518362%"/>
    <stop stopColor="#6AA9E6" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="large-drop-gradient-6" key="large-drop-gradient-6">
    <stop stopColor="#E5F2FF" offset="0%"/>
    <stop stopColor="#6AAAE6" offset="54.7518362%"/>
    <stop stopColor="#578ADC" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="large-drop-gradient-7" key="large-drop-gradient-7">
    <stop stopColor="#DEEBFF" offset="0%"/>
    <stop stopColor="#588DDC" offset="54.7518362%"/>
    <stop stopColor="#28569D" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="small-drop-gradient-1" key="small-drop-gradient-1">
    <stop stopColor="#EDC9D1" offset="0%"/>
    <stop stopColor="#E68A6F" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="small-drop-gradient-2" key="small-drop-gradient-2">
    <stop stopColor="#F3D2D7" offset="0%"/>
  <stop stopColor="#DDB7B9" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="small-drop-gradient-3" key="small-drop-gradient-3">
    <stop stopColor="#ECD5D6" offset="0%"/>
    <stop stopColor="#A4B9D5" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="small-drop-gradient-4" key="small-drop-gradient-4">
    <stop stopColor="#E0E2EC" offset="0%"/>
  <stop stopColor="#9DBAD9" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="small-drop-gradient-5" key="small-drop-gradient-5">
    <stop stopColor="#F1F9FF" offset="0%"/>
    <stop stopColor="#6AA9E6" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="small-drop-gradient-6" key="small-drop-gradient-6">
    <stop stopColor="#E5F2FF" offset="0%"/>
  <stop stopColor="#578ADC" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="28.5669501%" y1="3.31680676%" x2="91.8046749%" y2="100%" id="small-drop-gradient-7" key="small-drop-gradient-7">
    <stop stopColor="#DEEBFF" offset="0%"/>
    <stop stopColor="#28569D" offset="100%"/>
  </linearGradient>,
  <linearGradient x1="50%" y1="112.83976%" x2="50%" y2="0%" id="humidity-line-gradient" key="line-gradient">
